...
">
    ...
    <div class="bg_2" style="padding-top: 40px; background-color: #F9F9F9; margin-bottom: 40px">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="" style="padding-bottom: 20px; margin-bottom: 0!important;">
                        <div class="row">
                            <div class="col-sm-12">
                                <div >
    ...
    <div >
        <div class="container">
            <div class="row" style="background-image: url(https://storage.googleapis.com/mycashonline/public/bg_blue.png); background-repeat: no-repeat; background-size: cover; margin-left: 0; margin-right: 0">
                ...
                <div class="col-sm-4 col-xs-12" style="margin-top: 46px;">
                    <img src="https://storage.googleapis.com/mycashonline/public/3.png" alt="" style="margin:1px 0 0 0; width: 80%; margin-left: 10%; margin-right: 10%; margin-bottom: 70px">
                </div>
    ...
    <div style="padding-top: 40px; padding-bottom: 40px; background-color: #F9F9F9">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <div>
                                ...
                                <div class="rbd-review-slider">
                                    <div class="rbd-review-container">
                                        <div class="rbd-review review1.1 rbd-curr">
                                            ...
                                            <div class="stars">
                                                <i class="material-icons" style="color: orange">star</i>                                                <i class="material-icons" style="color: orange">star</i>
                                                <i class="material-icons" style="color: orange">star</i>
                                                <i class="material-icons" style="color: orange">star</i>                                                <i class="material-icons" style="color: orange">star</i>                                            </div>
    ...
    <div class="" style="padding-top: 40px!important; background-color: #F9F9F9; padding-bottom: 40px">
        <div class="container">

            <div class="row">
                <div class="col-sm-12">
                    <div class="" style="margin-left: 5%; width: 90%">
