                            ...
                            <div class="conone1" style="margin-bottom: 50px">
                                ...
                                <div class="col-sm-6" style=" margin-top: 5vh">
                                    <div style="">
                                        ...
                                        <div class="search_holder">
                                            <p>I understand that loans from $2,100 to $5000 require an asset such as a car to be used as security to qualify for the loan. This asset can be owned outright, or there can still be finance owing.</p>
                                            <div class="clearfix"></div>
                                        </div>
